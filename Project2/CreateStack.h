...
namespace Project2 {
	...
	/// <summary>
	/// Summary for CreateStack
	/// </summary>
	public ref class CreateStack : public System::Windows::Forms::Form
	{
	public:
		CreateStack(void)
		{
	...
	protected: void drawNode(PaintEventArgs^ e, int iterator, int x, int y, int prevx, int prevy, int adder)
	{
				   if (prevx != -1)
				   {
					   ...
					   e->Graphics->FillEllipse(gcnew System::Drawing::SolidBrush(System::Drawing::Color::Blue), prevx, prevy, 50, 50);
					   RectangleF rec = RectangleF(prevx + 15, prevy + 15, 50, 50);
					   e->Graphics->DrawString(gcnew String(to_string(S[iterator - 1]).c_str()),
				   ...
				   e->Graphics->FillEllipse(gcnew System::Drawing::SolidBrush(System::Drawing::Color::Blue), x, y, 50, 50);
				   RectangleF rec = RectangleF(x + 15, y + 15, 50, 50);
				   e->Graphics->DrawString(gcnew String(to_string(S[iterator]).c_str()),
					   this->Font, gcnew System::Drawing::SolidBrush(System::Drawing::Color::White),
					   rec);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &CreateStack::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &CreateStack::button2_Click);
			// 
			// textBox1
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &CreateStack::button3_Click);
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(1269, 11);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(1263, 34);
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(1163, 9);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(94, 46);
			this->button6->TabIndex = 22;
			this->button6->Text = L"Random Generation";
			this->button6->UseVisualStyleBackColor = true;
			this->button6->Click += gcnew System::EventHandler(this, &CreateStack::button6_Click);
			// 
			// CreateStack
			// 
			...
			this->Name = L"CreateStack";
			this->Text = L"CreateStack";
